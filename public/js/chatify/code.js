    ...
    if (messenger != 0) {
        ...
        $.ajax({
            ...
            success: (data) => {
                ...
                $(".messenger-infoView")
                    .find(".avatar")
                    .css("background-image", 'url("/public/uploads/' + (data.fetch.thumbnail ? data.fetch.thumbnail : 'avatar-de.png') + '")');
                $(".header-avatar").css(
                    "background-image",
                    'url("/public/uploads/' + (data.fetch.thumbnail ? data.fetch.thumbnail : 'avatar-de.png') + '")'
                );
