        ...
        <div class="topbar stick">
            ...
            <div class="top-area">
                ...
                <ul class="setting-area">
                    ...
                    <li><a href="#" title="Languages" data-ripple=""><i
                                class="fa fa-globe"></i><em>EN</em></a>
                    ...
                    <li><a href="#" title="Help" data-ripple=""><i class="fa fa-question-circle"></i></a>
                        <div class="dropdowns helps">
                            ...
                            <ul class="help-drop">
                                <li><a href="forum.html" title=""><i class="fa fa-book"></i>Community &
                                        Forum</a></li>
                                <li><a href="faq.html" title=""><i class="fa fa-question-circle-o"></i>FAQs</a>
                                </li>
                                <li><a href="career.html" title=""><i class="fa fa-building-o"></i>Carrers</a>
                                </li>
                                ...
                                <li><a href="#" title=""><i class="fa fa-exclamation-triangle"></i>Report
                                        a Problem</a></li>
                            </ul>
                        </div>
                    </li>
                ...
                <div class="user-img">
                    ...
                    <div class="user-setting">
                        ...
                        <ul class="log-out">
                            ...
                            <li><a href="setting.html" title=""><i class="ti-pencil-alt"></i>edit profile</a>
                            </li>
                            <li><a href="#" title=""><i class="ti-target"></i>activity log</a></li>
                            <li><a href="setting.html" title=""><i class="ti-settings"></i>account setting</a>
                            </li>
            ...
            <nav>
                <ul class="nav-list">
                    ...
                    <li><a class="" href="#" title=""><i class="fa fa-graduation-cap"></i>
                            Pitjob</a>
                        <ul>
                            <li><a href="career.html" title="">Pitjob</a></li>
                            <li><a href="career-detail.html" title="">Pitjob Detail</a></li>
                    ...
                    <li><a class="" href="#" title=""><i class="fa fa-heart"></i> Favourit
                            Page</a>
                        <ul>
                            <li><a href="fav-page.html" title="">Favourit Page</a></li>
                            <li><a href="fav-favers.html" title="">Fav Page Likers</a></li>
                    ...
                    <li><a class="" href="#" title=""><i class="fa fa-gears"></i> Account
                            Setting</a>
                        <ul>
                            <li><a href="setting.html" title="">Setting</a></li>
                            <li><a href="privacy.html" title="">Privacy</a></li>
                    ...
                    <li><a class="" href="#" title=""><i class="fa fa-lock"></i>
                            Authentication</a>
                        <ul>
                            <li><a href="login.html" title="">Login Page</a></li>
                            <li><a href="register.html" title="">Register Page</a></li>
        ...
        <section>
            <div class="page-header">
                <div class="header-inner">
                    ...
                    <p>
                        Welcome to Pitnik Social Network. This page is for the community where user can put some
                        technicial questions about the pitnik policies.
                    </p>
                </div>
                    ...
                    <div class="row merged20">
                        <div class="col-lg-9">
                            ...
                            <div class="forum-form">
                                <div class="central-meta">
                                    <form method="post" action="{{ route('blog.addPost') }}" class="c-form" enctype="multipart/form-data">
                                        @csrf
                                        <div>
                                            <label>Title</label>
                                            <input type="text" name="title" id="title"
                                                placeholder="Tile" aria-rowspan="3">
                                        </div>
                                        <div>
                                            <label>Content</label>
                                            <input type="text" name="content" id="content"
                                                placeholder="Content" aria-rowspan="3">
                                        </div>
                                        ...
                                        <div>
                                            <div class="form-group" id="uploadfile">
                                                ...
                                                <input style="display: none" type="file" name="file"
                                                    id="fileinput" onchange="chooseFile(this)">
                                            </div>
                                        </div>
                                        <div>
                                            <button class="main-btn" type="submit" data-ripple="">Post
                                                Topic</button>
