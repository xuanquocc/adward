                                                                ...
                                                                <form action="" method="post"
                                                                    ...
                                                                    <li id="edit-blog" data-toggle="modal"
                                                                        ...
                                                                        <i style="margin-right: 5px;"
                                                                            class="fas fa-thin fa-pen-to-square"></i>編集
                                                                    </li>
                                                                    <li id="delete-blog"><i style="margin-right: 5px;"
                                                        ...
                                                        @if (!empty($post->image))
                                                            <div class="thumbnail" style="width: 90%; margin: 0 auto;">
                                                                <img src="{{ url('/public/uploads/' . $post->image) }}"
                                                                    class="img" alt="" style="height: 300px;">
                                                            </div>
                                                        @endif
                                                    </div>
                                                    <div class="mt-4">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control input" id="name"
                                        autocomplete="off"　 placeholder="Name" value=""
                                        style="
                                        background-color: #ccc; padding: 5px 10px;">
                                </div>
                                <div class="form-group">
                                    <label for="phone"><b>内容</b></label>
                                    <input type="text" name="phone" class="form-control input" id="name"
                                        autocomplete="off" placeholder="Phone" value=""
                                        style="
