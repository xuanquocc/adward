...
<div class="theme-layout">
	...
	<div class="topbar stick">
		...
		<div class="top-area">
			...
			<div class="user-img">
				<h5>Jack Carter</h5>
				<img href="{{ asset('images/avatar.jpg') }}"  alt="admin">
				<span class="status f-online"></span>
				...
				<div class="row merged20">
					<div class="col-lg-9">
						<div class="forum-warper">
							...
							<a class="addnewforum" href="{{ route('blog.createPost') }}" title=""><i class="fa fa-plus"></i> Add New</a>
						</div>
						<div class="central-meta">
										...
										@foreach ($result as $post)
											<tr rowspan="3">
												<td colspan="5">
													...
													<a href="forums-category.html" title="">{{$post->title}}</a>
													<p>{{$post->content}}</p>
													@if (!empty($post->image))
														<div class="thumbnail" style="max-width: 800px; vertical-align:center;">
															<img src="{{ url('/public/uploads/' . $post->image) }}" class="img"
