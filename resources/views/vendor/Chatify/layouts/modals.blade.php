...
<div class="app-modal" data-name="delete">
    <div class="app-modal-container">
        <div class="app-modal-card" data-name="delete" data-modal='0'>
            <div class="app-modal-header">これを削除してもよろしいですか?</div>
            <div class="app-modal-body">この操作を元に戻すことはできません</div>
            <div class="app-modal-footer">
                <a href="javascript:void(0)" class="app-btn cancel">キャンセル
                </a>
                <a href="javascript:void(0)" class="app-btn a-btn-danger delete">デェテ</a>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="app-modal-card" data-name="settings" data-modal='0'>
            <form id="update-settings" action="{{ route('avatar.update') }}" enctype="multipart/form-data"
                ...
                <div class="app-modal-body">
                    ...
                    {{-- Dark/Light Mode  --}}
                    <p class="divider"></p>
                    <p class="app-modal-header">ダークモード <span
                            class="
                ...
                <div class="app-modal-footer">
                    ...
                    <input type="submit" class="app-btn a-btn-success update" value="変更内容を保存" />
                </div>
            </form>
        </div>
    </div>
