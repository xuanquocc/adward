        ...
        <main>
            <form id="login_form" class="form_class" action="{{ route('login.check')}}" method="post">
                ...
                <div class="form_div">
                    ...
                    <label>パスワード:</label>
                    <input id="pass" class="field_class" name="password" type="password" placeholder="パスワードを入力してください">
                    <button class="submit_class" type="submit" form="login_form" onclick="return validarLogin()">ログイン</button>
                </div>
                <div class="info_div">
